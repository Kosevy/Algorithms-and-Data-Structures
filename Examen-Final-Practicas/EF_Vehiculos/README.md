...
<img width="738" height="406" alt="image" src="https://github.com/user-attachments/assets/576da951-3b20-45cc-b96e-c58c452706fa" />

Rúbrica de calificación:
- Generador de datos: 2 puntos (Excelente), 1 punto (Regular), 0 puntos (Deficiente)
...
La clase MiArbolBinario permite representar árboles binarios de búsqueda para almacenar números enteros. Se solicita implementar las siguientes funciones:
 ...
 d. Cuarta función: En la clase MiArbolBinario se debe desarrollar la función producto_digitos, encontrar el mayor valor del árbol binario, y obtener el producto de sus dígitos, por ejemplo, si el número es 48, debe mostrar como resultado 4 * 8 = 32.
 e. Crear un menú de opciones para cada función.

-> Para que la solución se considere, la función propuesta debe estar correcta, no debe tener errores y funcione con cualquier entrada, se debe validar el ingreso a los datos. El código debe entenderse y ser claro.
-> No colocar funciones que no se solicitan.

 Rúbrica de calificación:
- Desarrollo de la función insertar para el árbol binario de búsqueda: 2 puntos (Excelente), 1 punto (Regular), 0 puntos (Deficiente)
- Desarrollo de la función promedio_rango para el ábol binario de búsqueda: 4 puntos (Excelente), 2 punto (Regular), 0 puntos (Deficiente)
- Desarrollo de la función enOrden para el árbol binario de búsqueda: 1 punto (Excelente), 0 punto (Regular), 0 puntos (Deficiente)
...
Se necesita implementar una opción que pueda crear un grafo, para representar los vértices, por ejemplo: 65, 69, 32, 18, 53 y 76. Se debe tener en cuenta que los vértices se encuentran conectados, se necesita implementar las siguientes funciones de grafos:
 ...
 Rúbrica de calificación:
- Desarrollo de la función registro_aleatorio del grafo: 2 puntos (Excelente), 1 punto (Regular), 0 puntos (Deficiente)
- Desarrollo de la función sumatoria_arcos del grafo: 2 puntos (Excelente), 1 punto (Regular), 0 puntos (Deficiente)
