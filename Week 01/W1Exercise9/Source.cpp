...
// Función para determinar si un elemento existe
template <typename T>
bool existeElemento(T arr[], int tamaño, T elemento) {
    for (int i = 0; i < tamaño; i++) {
        if (arr[i] == elemento) {
            return true;
        }
...
// Función para buscar un elemento (ahora usa existeElemento)
template <typename T>
void buscarElemento(T arr[], int tamaño) {
    ...
    if (existeElemento(arr, tamaño, elemento)) {
        cout << "El elemento " << elemento << " SI existe en el arreglo." << endl;
...
int main() {
    ...
    do {
        ...
        cout << "2. Verificar existencia de elemento" << endl;
        ...
        case '2': {
            int elemento;
            cout << "Ingrese el elemento a verificar: ";
            cin >> elemento;
            if (existeElemento(datos, d, elemento)) {
                cout << "El elemento SI existe en el arreglo." << endl;
            }
            else {
