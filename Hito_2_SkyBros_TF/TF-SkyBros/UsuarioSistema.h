...
public:
    bool mostrarMenuAutenticacion() {
        ...
        while (!autenticado && !salir) {
			...
			Console::SetCursorPosition(15, 8); cout << "3. Ver vuelos (sin iniciar sesion)";
            Console::SetCursorPosition(15, 9); cout << "0. Salir";
            ...
            case 3:
                {
                    GestorVuelos<string> gestorVuelos(nullptr);
                    gestorVuelos.mostrarVuelosPublicos();
