...
int mostrarInstrucciones()
{
    ...
    Console::SetCursorPosition(45, 2); cout << "SKYBROS";
    ...
    Console::SetCursorPosition(15, 8); cout << "3. Servicios adicionales";
    Console::SetCursorPosition(15, 9); cout << "4. Cerrar sesion";
